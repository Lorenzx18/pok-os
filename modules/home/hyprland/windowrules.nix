{host, ...}: let
  ...
  defaultWindowRules = [
        ...
        "match:class ^(vivaldi-stable)$, tag +browser"
        "match:class ^(zen-beta)$, tag +browser"
        ...
        "match:class ^(dev.zed.Zed)$, tag +ide"
        ...
        "match:class .*, idle_inhibit fullscreen on"
        "match:title .*, idle_inhibit fullscreen on"
        "match:fullscreen 1, idle_inhibit fullscreen on"
        "match:class ^(Moonlight)$, center on"
        ...
        "match:tag settings*, size 60% 70%"
        "match:tag browser*, opacity 0.9 0.7"
        "match:class ^(dev\\.heppen\\.webapps\\..*), opacity 0.9 0.9"
        "match:class ^(obsidian), opacity 0.9 0.9"
        "match:class ^(com.github.th_ch.youtube_music), opacity 0.9 0.9"
        "match:tag projects*, opacity 0.9 0.8"
        "match:tag im*, opacity 0.9 0.8"
        "match:tag file-manager*, opacity 0.9 0.8"
        "match:tag terminal*, opacity 0.8 0.7"
        "match:tag terminal*, opacity 0.8 0.7"
        "match:tag ide*, opacity 0.8 0.7"
        "match:tag settings*, opacity 0.8 0.7"
        "match:tag gamestore*, opacity 0.8 0.7"
