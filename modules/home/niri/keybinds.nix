...
''
  binds {
      ...
      Ctrl+Shift+S {
          spawn "sh" "-c" "/home/don/pok-os/modules/home/noctalia-shell/sync-from-gui.py && notify-send 'Noctalia Config' 'Settings synced to Nix template' -i preferences-system";
      }
